...
def move_to(var, device):
    if isinstance(var, dict):
        ...
        # Keep lists as is (e.g., path_lookup, node2osmid)
        return var
    elif isinstance(var, (int, float, str, bool)) or var is None:
        # Keep scalar values and None as is
        return var
    elif hasattr(var, 'to'):
