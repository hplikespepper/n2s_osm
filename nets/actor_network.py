...
class Actor(nn.Module):
    ...
    def forward(self, problem, x_in, solution, exchange, action_record, do_sample = False, fixed_action = None, require_entropy = False, to_critic = False, only_critic  = False, vehicle_assignment = None):
